...
final class RealCall implements Call {
    ...
    public C1769Response execute() throws IOException {
        synchronized (this) {
            if (!this.executed) {
                this.executed = true;
            } else {
        ...
        try {
            ...
            C1769Response responseWithInterceptorChain = getResponseWithInterceptorChain();
    ...
    /* access modifiers changed from: package-private */
    public C1769Response getResponseWithInterceptorChain() throws IOException {
        ...
        C1769Response proceed = new RealInterceptorChain(arrayList, (StreamAllocation) null, (HttpCodec) null, (RealConnection) null, 0, this.originalRequest, this, this.eventListener, this.client.connectTimeoutMillis(), this.client.readTimeoutMillis(), this.client.writeTimeoutMillis()).proceed(this.originalRequest);
